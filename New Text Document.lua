...
local M = Windows:MakeTab({"Discord","Info"})
local F = Windows:MakeTab({"Farm"})
local Q = Windows:MakeTab({"Nhiệm Vụ"})
local I = Windows:MakeTab({"Đồ"})
local Ea = Windows:MakeTab({"Tộc"})
local D = Windows:MakeTab({"Dojo"})
local V = Windows:MakeTab({"Đảo Lửa"})
local SS = Windows:MakeTab({"Status"})
local S = Windows:MakeTab({"Máy Chủ"})
local PVP = Windows:MakeTab({"Đánh Nhau"})
...
M:AddSection("Thông Tin")
    ...
    M:AddParagraph({
        Title="Phát Triển Bởi Karse Đẹp Trai",
