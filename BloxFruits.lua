...
local SeaTab = Library:Tab("Sea");
local StatsTab = Library:Tab("Stats");
local RaceV4Tab = Library:Tab("Race");
local CombatTab = Library:Tab("Combat");
local RaidTab = Library:Tab("Raid");
...
local ServTab = Library:Tab("Serv");
